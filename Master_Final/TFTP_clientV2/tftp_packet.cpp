...
bool TFTP_Packet::createRRQ(const char* filename) {
...
bool TFTP_Packet::createWRQ(const char* filename) {
...
bool TFTP_Packet::createError(int error_code, const char* message) {
